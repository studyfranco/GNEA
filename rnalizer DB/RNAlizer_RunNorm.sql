...
--
-- Table structure for table `RunNorm`
--

DROP TABLE IF EXISTS `RunNorm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RunNorm` (
  `IDRunNorm` int(10) unsigned zerofill NOT NULL,
  `Nom` varchar(100) NOT NULL,
  PRIMARY KEY (`IDRunNorm`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `RunNorm`
--

LOCK TABLES `RunNorm` WRITE;
/*!40000 ALTER TABLE `RunNorm` DISABLE KEYS */;
/*!40000 ALTER TABLE `RunNorm` ENABLE KEYS */;
UNLOCK TABLES;
