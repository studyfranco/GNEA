...
--
-- Table structure for table `biosequence`
--

DROP TABLE IF EXISTS `biosequence`;
...
CREATE TABLE `biosequence` (
  ...
  CONSTRAINT `FKbioentry_bioseq` FOREIGN KEY (`bioentry_id`) REFERENCES `bioentry` (`bioentry_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `biosequence`
--

LOCK TABLES `biosequence` WRITE;
/*!40000 ALTER TABLE `biosequence` DISABLE KEYS */;
/*!40000 ALTER TABLE `biosequence` ENABLE KEYS */;
UNLOCK TABLES;
