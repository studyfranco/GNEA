...
CREATE TABLE `term_dbxref` (
  ...
  KEY `trmdbxref_dbxrefid` (`dbxref_id`),
  CONSTRAINT `FKdbxref_trmdbxref` FOREIGN KEY (`dbxref_id`) REFERENCES `dbxref` (`dbxref_id`) ON DELETE CASCADE,
  CONSTRAINT `FKterm_trmdbxref` FOREIGN KEY (`term_id`) REFERENCES `term` (`term_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `term_dbxref`
--

LOCK TABLES `term_dbxref` WRITE;
/*!40000 ALTER TABLE `term_dbxref` DISABLE KEYS */;
/*!40000 ALTER TABLE `term_dbxref` ENABLE KEYS */;
UNLOCK TABLES;
