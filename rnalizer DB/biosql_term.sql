...
CREATE TABLE `term` (
  ...
  `is_obsolete` char(1) DEFAULT NULL,
  `ontology_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`term_id`),
  UNIQUE KEY `identifier` (`identifier`),
  UNIQUE KEY `name` (`name`,`ontology_id`,`is_obsolete`),
  KEY `term_ont` (`ontology_id`),
  CONSTRAINT `FKont_term` FOREIGN KEY (`ontology_id`) REFERENCES `ontology` (`ontology_id`) ON DELETE CASCADE
