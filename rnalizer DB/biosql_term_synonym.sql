...
CREATE TABLE `term_synonym` (
  `synonym` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`term_id`,`synonym`),
  CONSTRAINT `FKterm_syn` FOREIGN KEY (`term_id`) REFERENCES `term` (`term_id`) ON DELETE CASCADE
