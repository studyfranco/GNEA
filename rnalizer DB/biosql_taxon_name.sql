...
CREATE TABLE `taxon_name` (
  ...
  `name_class` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  UNIQUE KEY `taxon_id` (`taxon_id`,`name`,`name_class`),
  KEY `taxnametaxonid` (`taxon_id`),
  KEY `taxnamename` (`name`),
  CONSTRAINT `FKtaxon_taxonname` FOREIGN KEY (`taxon_id`) REFERENCES `taxon` (`taxon_id`) ON DELETE CASCADE
