...
--
-- Table structure for table `NormParam`
--

DROP TABLE IF EXISTS `NormParam`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `NormParam` (
  `IDNorm` int(5) unsigned zerofill NOT NULL,
...
--
-- Dumping data for table `NormParam`
--

LOCK TABLES `NormParam` WRITE;
/*!40000 ALTER TABLE `NormParam` DISABLE KEYS */;
/*!40000 ALTER TABLE `NormParam` ENABLE KEYS */;
UNLOCK TABLES;
