...
--
-- Table structure for table `SCGroup`
--

DROP TABLE IF EXISTS `SCGroup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `SCGroup` (
  `GroupSC` varchar(100) NOT NULL,
...
--
-- Dumping data for table `SCGroup`
--

LOCK TABLES `SCGroup` WRITE;
/*!40000 ALTER TABLE `SCGroup` DISABLE KEYS */;
/*!40000 ALTER TABLE `SCGroup` ENABLE KEYS */;
UNLOCK TABLES;
