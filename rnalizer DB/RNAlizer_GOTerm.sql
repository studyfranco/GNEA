...
CREATE TABLE `GOTerm` (
  ...
  `Nom` int(11) NOT NULL,
  `FKOnt` int(11) NOT NULL,
  PRIMARY KEY (`IDGo`),
  KEY `FKOnt` (`FKOnt`),
  CONSTRAINT `GOTerm_ibfk_1` FOREIGN KEY (`FKOnt`) REFERENCES `Ontology` (`IDont`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `GOTerm`
--

LOCK TABLES `GOTerm` WRITE;
/*!40000 ALTER TABLE `GOTerm` DISABLE KEYS */;
/*!40000 ALTER TABLE `GOTerm` ENABLE KEYS */;
UNLOCK TABLES;
