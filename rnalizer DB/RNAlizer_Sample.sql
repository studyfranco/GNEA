...
CREATE TABLE `Sample` (
  `IDSample` varchar(60) NOT NULL,
  `Nom` varchar(50) NOT NULL,
  `FKGroupEchant` varchar(30) NOT NULL,
  `Type` varchar(20) NOT NULL,
  PRIMARY KEY (`IDSample`),
  UNIQUE KEY `Nom` (`Nom`),
  UNIQUE KEY `FKGroupEchant` (`FKGroupEchant`),
  KEY `Type` (`Type`),
  CONSTRAINT `Sample_ibfk_1` FOREIGN KEY (`Type`) REFERENCES `TypeSample` (`TypeSample`) ON UPDATE CASCADE
