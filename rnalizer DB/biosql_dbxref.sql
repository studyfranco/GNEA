...
CREATE TABLE `dbxref` (
  ...
  `dbname` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `accession` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `version` smallint(5) unsigned NOT NULL,
  PRIMARY KEY (`dbxref_id`),
  UNIQUE KEY `accession` (`accession`,`dbname`,`version`),
  KEY `dbxref_db` (`dbname`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dbxref`
--

LOCK TABLES `dbxref` WRITE;
/*!40000 ALTER TABLE `dbxref` DISABLE KEYS */;
/*!40000 ALTER TABLE `dbxref` ENABLE KEYS */;
UNLOCK TABLES;
